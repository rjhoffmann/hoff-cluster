...
source "/Users/ryan/Source/hoff-cluster/.devenv/shell-env.sh"
...
__devenv_reload_apply() {
    ...
    if [ -f "/var/folders/tg/wqg4z_gs601cq87x45pd52nw0000gn/T/devenv-reload-16149.sh" ]; then
        ...
        source "/var/folders/tg/wqg4z_gs601cq87x45pd52nw0000gn/T/devenv-reload-16149.sh"
        rm -f "/var/folders/tg/wqg4z_gs601cq87x45pd52nw0000gn/T/devenv-reload-16149.sh"
